...
def generate_months(months):
    ...
    for first_day, last_day in starting_and_end_days:
        ...
        if str(last_day.split("-")[1]) == "12":
            one_month_forward = "01"
        else:
        ...
        with conn:
            ...
            try:
                for index, month_t in enumerate(months_total):
                    ...
                    if "0" in month_id and month_id != "10":
                        month_id = year + month_id.replace("0", "")
                    else:
                        month_id = year + month_id
            ...
            try:
                ...
                if "0" in first_date and first_date != "10":
                    month_id = year + first_date.split("-")[1].replace("0","")
                else:
                    month_id = year + first_date.split("-")[1]
